    ...
    * ======================================== */
    (function ($) {
        ...
        var modalContentTmp = {
            ...
            // External Links CN
            type01cn: '<div class="box-text"><p>You will be accessing an external site.</p><p>Click "OK" to continue.</p></div><div class="align-c"><a href="{{href}}" target="_blank" class="btn-03 btn-small">OK<img src="/hongkong/share/images/icon_link_blank_04.png" alt="Open in new window" class="icon-blank"></a></div>',
            ...
            //hk
            type07: '<div class="box-offices-globalarea"><div class="box-offices-globalarea-outer"><div class="box-inner"><div class="box-panel"><!--Hong Kong --><div class="panel"><div class="box-thumb"><img src="images/index_img_regionalnetwork_panel_hongkong_01.jpg" alt=""></div><div class="box-content"><h3 class="title"><span class="sub">HONG KONG</span>Kyowa Kirin Hong Kong Co., Ltd </h3><p class="box-text">Unit B, 13/F., 169 Electric Road<br>North Point, Hong Kong<br>Tel: +852 2956 0828<br>Fax: +852 2956 1627</p><!--<p class="link-icon link-text"><span>Visit website</span></p>--></div><!-- /.panel Hong Kong--></div><!-- /.box-panel --></div><!-- /.box-inner --></div><!-- /.box-offices-globalarea-outer --></div>',
            //ko
            ...
            type51cn: '<div class="box-text"><p class="text-lead">以下資訊僅供專業醫護人員參考。請確認閣下是否專業醫護人員？</p></div><div class="align-c"><a href="{{href}}" class="btn-03 btn-large">是，本人確認為專業醫護人員， 並已查閱及同意接受本網站之使用條款及私隱政策內容。</a><br/><br/><a class="btn-03 btn-large">否，本人並不是專業醫護人員。</a></div>',
