    ...
    * ======================================== */
    (function ($) {
        ...
        var modalContentTmp = {
            ...
            // Disclaimer  Links
            type21: '<div class="box-text"><p>The information contained in this section is intended for healthcare professionals only. Please confirm you are a healthcare professional.</p></div><div class="align-c"><a href="{{href}}" class="btn-03 btn-large">Yes, I am a healthcare professional</a><br/><br/><a class="btn-03 btn-large">No, I am not a healthcare professional</a></div>',
            ...
            //au
            type05: '<div class="box-offices-globalarea"><div class="box-offices-globalarea-outer"><div class="box-inner"><div class="box-panel"><!--Australia --><div class="panel"><div class="box-thumb"><img src="images/index_img_regionalnetwork_panel_australia_01.jpg" alt=""></div><div class="box-content"><h3 class="title"><span class="sub">AUSTRALIA</span>Kyowa Kirin Australia Pty Ltd</h3><p class="box-text">68 York Street<br>Sydney<br>NSW 2000, Australia<br><br/>E-mail:<a href="mailto:enquiry.kkau@kyowakirin.com" target="_blank">&nbsp;enquiry.kkau@kyowakirin.com</a></p><a href="https://www.kyowakirin.com/australia/index.html" target="_blank" class=" outBoundModalLink"><p class="link-icon link-text"><span>Visit website</span></p></a></div><!-- /.panel Australia --></div><!-- /.box-panel --></div><!-- /.box-inner --></div><!-- /.box-offices-globalarea-outer --></div>',
            //ch
